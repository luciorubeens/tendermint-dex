...
> extends HttpClient<SecurityDataType> {
	...
	) => Promise<HttpResponse<V1QueryChannelsResponse, RpcStatus>>
	/**
	 * No description
	 *
	 * @tags Query
	...
	queryChannel: (
		...
		portId: string,
		params?: RequestParams
	) => Promise<HttpResponse<V1QueryChannelResponse, RpcStatus>>
	/**
   * No description
   *
   * @tags Query
   ...
   */
	queryChannelClientState: (
		...
		portId: string,
		params?: RequestParams
	) => Promise<HttpResponse<V1QueryChannelClientStateResponse, RpcStatus>>
	/**
   * No description
   *
   * @tags Query
   ...
   */
	queryChannelConsensusState: (
		...
		revisionHeight: string,
		params?: RequestParams
	) => Promise<HttpResponse<V1QueryChannelConsensusStateResponse, RpcStatus>>
	/**
	 * No description
	 *
	 * @tags Query
	...
	queryNextSequenceReceive: (
		...
		portId: string,
		params?: RequestParams
	) => Promise<HttpResponse<V1QueryNextSequenceReceiveResponse, RpcStatus>>
	/**
   * No description
   *
   * @tags Query
   ...
   */
	queryPacketAcknowledgements: (
		...
		params?: RequestParams
	) => Promise<HttpResponse<V1QueryPacketAcknowledgementsResponse, RpcStatus>>
	/**
	 * No description
	 *
	 * @tags Query
	...
	queryPacketAcknowledgement: (
		...
		sequence: string,
		params?: RequestParams
	) => Promise<HttpResponse<V1QueryPacketAcknowledgementResponse, RpcStatus>>
	/**
   * No description
   *
   * @tags Query
   ...
   */
	queryPacketCommitments: (
		...
		params?: RequestParams
	) => Promise<HttpResponse<V1QueryPacketCommitmentsResponse, RpcStatus>>
	/**
   * No description
   *
   * @tags Query
   ...
   */
	queryUnreceivedAcks: (
		...
		params?: RequestParams
	) => Promise<HttpResponse<V1QueryUnreceivedAcksResponse, RpcStatus>>
	/**
   * No description
   *
   * @tags Query
   ...
   */
	queryUnreceivedPackets: (
		...
		params?: RequestParams
	) => Promise<HttpResponse<V1QueryUnreceivedPacketsResponse, RpcStatus>>
	/**
	 * No description
	 *
	 * @tags Query
	...
	queryPacketCommitment: (
		...
		sequence: string,
		params?: RequestParams
	) => Promise<HttpResponse<V1QueryPacketCommitmentResponse, RpcStatus>>
	/**
	 * No description
	 *
	 * @tags Query
	...
	queryPacketReceipt: (
		...
		sequence: string,
		params?: RequestParams
	) => Promise<HttpResponse<V1QueryPacketReceiptResponse, RpcStatus>>
	/**
   * No description
   *
   * @tags Query
   ...
   */
	queryConnectionChannels: (
		...
		params?: RequestParams
	) => Promise<HttpResponse<V1QueryConnectionChannelsResponse, RpcStatus>>
}
export {}
