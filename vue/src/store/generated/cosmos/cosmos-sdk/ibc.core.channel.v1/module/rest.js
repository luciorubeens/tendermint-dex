...
export class Api extends HttpClient {
	constructor() {
		 ...
		 */
		this.queryChannels = (query, params = {}) =>
			this.request({
		 ...
		 */
		this.queryChannel = (channelId, portId, params = {}) =>
			this.request({
       ...
       */
		this.queryChannelClientState = (channelId, portId, params = {}) =>
			this.request({
       ...
       */
		this.queryChannelConsensusState = (
			channelId,
			portId,
			revisionNumber,
			revisionHeight,
		 ...
		 */
		this.queryNextSequenceReceive = (channelId, portId, params = {}) =>
			this.request({
       ...
       */
		this.queryPacketAcknowledgements = (
			channelId,
			portId,
			query,
			params = {}
		 ...
		 */
		this.queryPacketAcknowledgement = (
			channelId,
			portId,
			sequence,
			params = {}
       ...
       */
		this.queryPacketCommitments = (channelId, portId, query, params = {}) =>
			this.request({
       ...
       */
		 ...
		 */
		this.queryPacketCommitment = (channelId, portId, sequence, params = {}) =>
			this.request({
		 ...
		 */
		this.queryPacketReceipt = (channelId, portId, sequence, params = {}) =>
			this.request({
       ...
       */
		this.queryConnectionChannels = (connection, query, params = {}) =>
			this.request({
