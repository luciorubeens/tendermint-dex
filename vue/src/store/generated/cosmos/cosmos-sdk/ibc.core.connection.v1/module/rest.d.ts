...
> extends HttpClient<SecurityDataType> {
   ...
   */
	...
	) => Promise<HttpResponse<V1QueryClientConnectionsResponse, RpcStatus>>
	/**
	 * No description
	 *
	 * @tags Query
	...
	queryConnections: (
		...
		params?: RequestParams
	) => Promise<HttpResponse<V1QueryConnectionsResponse, RpcStatus>>
	/**
	 * No description
	 *
	 * @tags Query
	...
	queryConnection: (
		connectionId: string,
		params?: RequestParams
	) => Promise<HttpResponse<V1QueryConnectionResponse, RpcStatus>>
	/**
   * No description
   *
   * @tags Query
   ...
   */
	queryConnectionClientState: (
		connectionId: string,
		params?: RequestParams
	) => Promise<HttpResponse<V1QueryConnectionClientStateResponse, RpcStatus>>
	/**
   * No description
   *
   * @tags Query
   ...
   */
	queryConnectionConsensusState: (
		...
		revisionHeight: string,
		params?: RequestParams
	) => Promise<HttpResponse<V1QueryConnectionConsensusStateResponse, RpcStatus>>
}
export {}
