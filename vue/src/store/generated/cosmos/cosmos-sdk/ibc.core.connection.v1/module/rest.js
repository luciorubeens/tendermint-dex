...
export class Api extends HttpClient {
	constructor() {
       ...
       */
		this.queryClientConnections = (clientId, params = {}) =>
			this.request({
		 ...
		 */
		this.queryConnections = (query, params = {}) =>
			this.request({
		 ...
		 */
		this.queryConnection = (connectionId, params = {}) =>
			this.request({
       ...
       */
		this.queryConnectionClientState = (connectionId, params = {}) =>
			this.request({
       ...
       */
		this.queryConnectionConsensusState = (
			connectionId,
			revisionNumber,
			revisionHeight,
			params = {}
