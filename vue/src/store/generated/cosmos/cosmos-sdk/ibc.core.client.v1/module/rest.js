...
export class Api extends HttpClient {
	constructor() {
		 ...
		 */
		this.queryClientStates = (query, params = {}) =>
			this.request({
		 ...
		 */
		this.queryClientState = (clientId, params = {}) =>
			this.request({
       ...
       */
		this.queryConsensusStates = (clientId, query, params = {}) =>
			this.request({
