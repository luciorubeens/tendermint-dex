...
> extends HttpClient<SecurityDataType> {
	...
	queryLiquidityPools: (
		...
		params?: RequestParams
	) => Promise<HttpResponse<V1Beta1QueryLiquidityPoolsResponse, RpcStatus>>
	/**
	...
	queryLiquidityPool: (
		poolId: string,
		params?: RequestParams
	) => Promise<HttpResponse<V1Beta1QueryLiquidityPoolResponse, RpcStatus>>
	/**
	...
	queryLiquidityPoolBatch: (
		poolId: string,
		params?: RequestParams
	) => Promise<HttpResponse<V1Beta1QueryLiquidityPoolBatchResponse, RpcStatus>>
	/**
	...
	queryPoolBatchDepositMsgs: (
		...
		HttpResponse<V1Beta1QueryPoolBatchDepositMsgsResponse, RpcStatus>
	>
	/**
	...
	queryPoolBatchDepositMsg: (
		...
		msgIndex: string,
		params?: RequestParams
	) => Promise<HttpResponse<V1Beta1QueryPoolBatchDepositMsgResponse, RpcStatus>>
	/**
	...
	queryPoolBatchSwapMsgs: (
		...
		params?: RequestParams
	) => Promise<HttpResponse<V1Beta1QueryPoolBatchSwapMsgsResponse, RpcStatus>>
	/**
	...
	queryPoolBatchSwapMsg: (
		...
		msgIndex: string,
		params?: RequestParams
	) => Promise<HttpResponse<V1Beta1QueryPoolBatchSwapMsgResponse, RpcStatus>>
	/**
	...
	queryPoolBatchWithdrawMsgs: (
		...
		HttpResponse<V1Beta1QueryPoolBatchWithdrawMsgsResponse, RpcStatus>
	>
	/**
	...
	queryPoolBatchWithdrawMsg: (
		...
		HttpResponse<V1Beta1QueryPoolBatchWithdrawMsgResponse, RpcStatus>
	>
}
export {}
