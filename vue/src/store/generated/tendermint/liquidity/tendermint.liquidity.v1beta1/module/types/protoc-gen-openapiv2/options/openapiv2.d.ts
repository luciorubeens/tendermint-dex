...
export declare function jSONSchema_JSONSchemaSimpleTypesFromJSON(
	object: any
): JSONSchema_JSONSchemaSimpleTypes
export declare function jSONSchema_JSONSchemaSimpleTypesToJSON(
...
export declare function securityScheme_TypeFromJSON(
	object: any
): SecurityScheme_Type
export declare function securityScheme_TypeToJSON(
...
export declare function securityScheme_InFromJSON(
	object: any
): SecurityScheme_In
export declare function securityScheme_InToJSON(
	object: SecurityScheme_In
): string
/**
 * The flow used by the OAuth2 security scheme. Valid values are
 * "implicit", "password", "application" or "accessCode".
...
export declare function securityScheme_FlowFromJSON(
	object: any
): SecurityScheme_Flow
export declare function securityScheme_FlowToJSON(
