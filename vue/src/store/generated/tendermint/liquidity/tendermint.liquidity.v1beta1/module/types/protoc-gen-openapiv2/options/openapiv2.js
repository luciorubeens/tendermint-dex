...
;(function (JSONSchema_JSONSchemaSimpleTypes) {
	JSONSchema_JSONSchemaSimpleTypes[
		(JSONSchema_JSONSchemaSimpleTypes['UNKNOWN'] = 0)
	] = 'UNKNOWN'
	JSONSchema_JSONSchemaSimpleTypes[
		(JSONSchema_JSONSchemaSimpleTypes['ARRAY'] = 1)
	] = 'ARRAY'
	JSONSchema_JSONSchemaSimpleTypes[
		(JSONSchema_JSONSchemaSimpleTypes['BOOLEAN'] = 2)
	] = 'BOOLEAN'
	JSONSchema_JSONSchemaSimpleTypes[
		(JSONSchema_JSONSchemaSimpleTypes['INTEGER'] = 3)
	] = 'INTEGER'
	JSONSchema_JSONSchemaSimpleTypes[
		(JSONSchema_JSONSchemaSimpleTypes['NULL'] = 4)
	] = 'NULL'
	JSONSchema_JSONSchemaSimpleTypes[
		(JSONSchema_JSONSchemaSimpleTypes['NUMBER'] = 5)
	] = 'NUMBER'
	JSONSchema_JSONSchemaSimpleTypes[
		(JSONSchema_JSONSchemaSimpleTypes['OBJECT'] = 6)
	] = 'OBJECT'
	JSONSchema_JSONSchemaSimpleTypes[
		(JSONSchema_JSONSchemaSimpleTypes['STRING'] = 7)
	] = 'STRING'
	JSONSchema_JSONSchemaSimpleTypes[
		(JSONSchema_JSONSchemaSimpleTypes['UNRECOGNIZED'] = -1)
	] = 'UNRECOGNIZED'
...
;(function (SecurityScheme_Type) {
	SecurityScheme_Type[(SecurityScheme_Type['TYPE_INVALID'] = 0)] =
		'TYPE_INVALID'
	SecurityScheme_Type[(SecurityScheme_Type['TYPE_BASIC'] = 1)] = 'TYPE_BASIC'
	SecurityScheme_Type[(SecurityScheme_Type['TYPE_API_KEY'] = 2)] =
		'TYPE_API_KEY'
	SecurityScheme_Type[(SecurityScheme_Type['TYPE_OAUTH2'] = 3)] = 'TYPE_OAUTH2'
	SecurityScheme_Type[(SecurityScheme_Type['UNRECOGNIZED'] = -1)] =
		'UNRECOGNIZED'
...
;(function (SecurityScheme_Flow) {
	SecurityScheme_Flow[(SecurityScheme_Flow['FLOW_INVALID'] = 0)] =
		'FLOW_INVALID'
	SecurityScheme_Flow[(SecurityScheme_Flow['FLOW_IMPLICIT'] = 1)] =
		'FLOW_IMPLICIT'
	SecurityScheme_Flow[(SecurityScheme_Flow['FLOW_PASSWORD'] = 2)] =
		'FLOW_PASSWORD'
	SecurityScheme_Flow[(SecurityScheme_Flow['FLOW_APPLICATION'] = 3)] =
		'FLOW_APPLICATION'
	SecurityScheme_Flow[(SecurityScheme_Flow['FLOW_ACCESS_CODE'] = 4)] =
		'FLOW_ACCESS_CODE'
	SecurityScheme_Flow[(SecurityScheme_Flow['UNRECOGNIZED'] = -1)] =
		'UNRECOGNIZED'
