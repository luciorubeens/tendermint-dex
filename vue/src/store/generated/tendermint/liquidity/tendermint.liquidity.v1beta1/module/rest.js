...
export class Api extends HttpClient {
	constructor() {
		 ...
		 */
		this.queryLiquidityPools = (query, params = {}) =>
			this.request({
		 ...
		 */
		this.queryLiquidityPool = (poolId, params = {}) =>
			this.request({
		 ...
		 */
		this.queryLiquidityPoolBatch = (poolId, params = {}) =>
			this.request({
		 ...
		 */
		this.queryPoolBatchDepositMsgs = (poolId, query, params = {}) =>
			this.request({
		 ...
		 */
		this.queryPoolBatchDepositMsg = (poolId, msgIndex, params = {}) =>
			this.request({
		 ...
		 */
		this.queryPoolBatchSwapMsgs = (poolId, query, params = {}) =>
			this.request({
		 ...
		 */
		this.queryPoolBatchSwapMsg = (poolId, msgIndex, params = {}) =>
			this.request({
		 ...
		 */
		this.queryPoolBatchWithdrawMsgs = (poolId, query, params = {}) =>
			this.request({
		 ...
		 */
		this.queryPoolBatchWithdrawMsg = (poolId, msgIndex, params = {}) =>
			this.request({
